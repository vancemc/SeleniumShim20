...
namespace SeleniumShim20
{
    public class WebBrowser
    {
        ...
        /// <returns></returns>
        public void SendKeys(By by, string text, bool includeReturnKeyPress=false)
        {
        ...
        public IWebElement ClickElement(By by)
        {
        ...
        /// <param name="by"></param>
        /// <returns>IWebElement</returns>
        public IWebElement ClearElement(By by)
        {
        ...
        public string GetUserInput(string prompt = "SeleniumShim: Get User input", 
        ...
        /// <param name="by">By locator</param>
        /// <returns>true if element found and element.Displayed property is set to true</returns>
        public bool ElementIsVisible(By by, int overrideTimeout)
        {
            bool result;
            IWebElement element;
            int elementSearchTimeOut = ElementSearchTimeout;
            ...
            {
                ElementSearchTimeout = elementSearchTimeOut;
            }
